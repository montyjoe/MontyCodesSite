$( document ).ready(function() {
  ...
  $(".about-me-button").click(function(){
    if( $(".about-me-button").hasClass('about-me-button-off') && ( $(".projects-button").hasClass('projects-button-off'))) {
      ...
      $(".about-me-button").animate({top: '-=60%'}, {queue: false, duration: 700}).animate({fontSize: "7.5vw"}, { queue: false, duration: 1100 });
      $(".about-me-img").animate({left: '-=96%'}, 2000);
      $(".about-me-text").animate({left: '-=100%'}, 2000);
      $(".contact-info").animate({left: '-=100%'}, 2000);
      ...
      $(".about-me-button").animate({fontSize: '7.5vw'}, 1200);
      $(".projects-box").animate({top: '+=100%'}, 1000);
      $(".projects-button").animate({top: '+=61%'}, {queue: false, duration: 1000}).animate({fontSize: "6vw"}, { queue: false, duration: 1000 });
      $(".about-me-img").animate({left: '-=96%'}, 2000);
      $(".about-me-text").animate({left: '-=100%'}, 2000);
      $(".contact-info").animate({left: '-=100%'}, 2000);
      $(".about-me-button").removeClass("about-me-button-off").addClass("about-me-button-on");
      ...
      $(".body-title").animate({top: '+=17%'}, 900);
      $(".about-me-button").animate({top: '+=60%'}, {queue: false, duration: 900}).animate({fontSize: "6vw"}, { queue: false, duration: 700 });
      $(".about-me-img").hide(300);
      $(".about-me-img").animate({left: '+=96%'}, 200);
      $(".about-me-text").animate({left: '+=100%'}, 200);
      $(".contact-info").animate({left: '+=100%'}, 200);
  ...
  $(".projects-button").click(function(){
    if( $(".projects-button").hasClass('projects-button-off') && ( $(".about-me-button").hasClass('about-me-button-off'))) {
      ...
      $(".projects-button").animate({top: '-=61%'}, {queue: false, duration: 1200}).animate({fontSize: "7.5vw"}, { queue: false, duration: 1200 });
      $(".projects-box").animate({top: '-=99%'}, 2000);
      ...
      $(".about-me-button").animate({fontSize: '6vw'}, 1100);
      $(".projects-button").animate({top: '-=61%'}, {queue: false, duration: 1200}).animate({fontSize: "7.5vw"}, { queue: false, duration: 1200 });
      $(".projects-box").animate({top: '-=98%'}, 2000);
      $(".about-me-img").hide(300);
      $(".about-me-img").animate({left: '+=96%'}, 200);
      $(".about-me-text").animate({left: '+=100%'}, 200);
      $(".contact-info").animate({left: '+=100%'}, 200);
      ...
      $(".projects-box").animate({top: '+=98%'}, 1000);
      $(".body-name").animate({top: '+=16%'}, 1200);
      $(".body-title").animate({top: '+=17%'}, 1100);
      $(".about-me-button").animate({top: '+=60%'}, 900);
      $(".projects-button").animate({top: '+=61%'}, {queue: false, duration: 700}).animate({fontSize: "6vw"}, { queue: false, duration: 700 });
      $(".title-button").show(1500);
      $(".projects-button").removeClass("projects-button-on").addClass("projects-button-off");
    }
  });
